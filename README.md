...
[![CI](https://github.com/oryokentucky/freightflow/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR_USERNAME/freightflow/actions)
...
```bash
git clone https://github.com/oryokentucky/freightflow
cd freightflow
cp .env.example .env
docker compose up -d
